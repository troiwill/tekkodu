...
namespace Kodu {
	...
	bool TokenParser::parseTokens(const std::vector<std::string>& koduStrings,
...
// =================================== Default response if not any of the others ======================== //
	...
	bool TokenParser::readText(std::vector<std::string>& koduStrings) {
	...
	int TokenParser::contains(const std::vector<TokenBase*>& tokens, const std::string& searchItem) {
